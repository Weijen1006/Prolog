	...
	fightbanana :- write('A Banana Skit appears !'),nl,write('Clemen thought to himself "That is a funny looking banana split."'),assert(enemy(ice,'Banana Skit', 5)),assert(round(1)),nl,nl,battlestatus,nl,battle.
